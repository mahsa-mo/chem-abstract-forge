...
const dictionaries: Record<Locale, Dict> = {
  en: {
    ...
    "editor.brush": "Brush",
    "editor.eraseToColor": "Erase to background colour (off = transparent)",
    "editor.textPlaceholder": "Type your label…",
    "editor.size": "Size",
    "editor.textColor": "Text colour",
    "editor.textHint": "Click on the image to place the text.",
    "editor.cropHint": "Drag a rectangle on the image, then apply.",
    "editor.applyCrop": "Apply crop",
    "editor.background": "Background",
    "editor.applyBackground": "Add colour behind image",
